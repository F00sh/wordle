import { defineComponent, mergeProps, useSSRContext, reactive, unref } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderComponent } from "vue/server-renderer";
import { _ as _export_sfc } from "../server.mjs";
import "C:/Users/Vili/Desktop/wordle/node_modules/ofetch/dist/node.mjs";
import "#internal/nuxt/paths";
import "C:/Users/Vili/Desktop/wordle/node_modules/hookable/dist/index.mjs";
import "C:/Users/Vili/Desktop/wordle/node_modules/unctx/dist/index.mjs";
import "C:/Users/Vili/Desktop/wordle/node_modules/h3/dist/index.mjs";
import "vue-router";
import "C:/Users/Vili/Desktop/wordle/node_modules/radix3/dist/index.mjs";
import "C:/Users/Vili/Desktop/wordle/node_modules/defu/dist/defu.mjs";
import "C:/Users/Vili/Desktop/wordle/node_modules/ufo/dist/index.mjs";
...
const WordleBoard = Object.assign(_sfc_main$2, { __name: "WordleBoard" });
...
const WordleKeyboard = Object.assign(_sfc_main$1, { __name: "WordleKeyboard" });
const WORDS = [
  "about",
  "above",
  "abuse",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const { state, inputLetter, backspace, submit } = useWordle();
    function onKey(key) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center px-4 pt-6 safe-bottom" }, _attrs))} data-v-8498dd58><header class="w-full max-w-xl flex items-center justify-between mb-4" data-v-8498dd58><h1 class="text-xl sm:text-2xl font-extrabold tracking-wide" data-v-8498dd58>Wordle</h1><button class="text-sm bg-absent hover:bg-gray-600 px-3 py-1.5 rounded" data-v-8498dd58>New</button></header><main class="w-full flex flex-col gap-4 items-center" data-v-8498dd58>`);
      _push(ssrRenderComponent(WordleBoard, {
        board: unref(state).board,
        "current-row": unref(state).currentRow
      }, null, _parent));
      if (unref(state).message) {
        _push(`<div class="fixed top-4 left-1/2 -translate-x-1/2 bg-tile text-white px-4 py-2 rounded shadow" data-v-8498dd58>${ssrInterpolate(unref(state).message)}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(state).status !== "playing") {
        _push(`<div class="text-sm text-gray-300" data-v-8498dd58>`);
        if (unref(state).status === "won") {
          _push(`<span data-v-8498dd58>You won! 🎉</span>`);
        } else {
          _push(`<span data-v-8498dd58>The word was <strong data-v-8498dd58>${ssrInterpolate(unref(state).answer)}</strong>.</span>`);
        }
        _push(`</div>`);
      } else {
        _push(`<!---->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8498dd58"]]);
export {
  index as default
};
//# sourceMappingURL=index-BI0d4RD6.js.map
